...
window.icon = (function () {
  ...
  var ICONS = {
    ...
    cloud: stroke('<path d="M17.5 19H7a5 5 0 1 1 1.2-9.85A6.5 6.5 0 0 1 20 12.5 3.5 3.5 0 0 1 17.5 19z"/>'),
    cloudRain: stroke('<path d="M17.5 16H7a5 5 0 1 1 1.2-9.85A6.5 6.5 0 0 1 20 9.5 3.5 3.5 0 0 1 17.5 16z"/><path d="m8 19-1 2M13 19l-1 2M18 19l-1 2"/>'),
    wind: stroke('<path d="M3 8h10a3 3 0 1 0-3-3M3 12h15a3 3 0 1 1-3 3M3 16h7"/>'),
    mapPin: stroke('<path d="M20 10c0 5-8 11-8 11S4 15 4 10a8 8 0 1 1 16 0z"/><circle cx="12" cy="10" r="2.5"/>'),
