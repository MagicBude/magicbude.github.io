...
window.i18n = (function () {
  ...
  var dict = {
    zh: {
      ...
      "uses.eyebrow": "工作台",
      "uses.title": "本站如何被制作",
      "uses.lead": "先公开能够从仓库确认的制作流程；个人设备与日常软件等信息，确认以后再加入。",
      "uses.snapshot.kicker": "VERIFIED WORKFLOW",
      "uses.snapshot.note": "这里的“正在使用”只指已核实的本站工作流，不延伸猜测个人设备。",
      "uses.updated": "最后核对",
      "uses.categories": "流程分组",
      "uses.steps": "确认条目",
      "uses.references": "参考工具",
      "uses.gearTitle": "已确认的工作台",
      "uses.gearLead": "这些内容可以直接由当前仓库结构、文件和发布方式验证。",
      "uses.toolboxTitle": "参考工具箱",
      "uses.toolboxLead": "一份精简的软件索引，方便需要时回看；收录不代表已经安装、购买或正在使用。",
      "uses.filterAll": "全部",
      "uses.officialSite": "访问官网",
      "uses.viewReference": "查看资料",
      "uses.empty": "这个分类还没有工具。",
      ...
      "links.eyebrow": "导航",
      "links.title": "书签与连接",
      "links.lead": "真实交换的朋友站点，以及与本站制作方式直接相关、仍值得回看的网页资源。",
      "links.snapshot.kicker": "CURATED LINKS",
      "links.updated": "最后核对",
      "links.friendsCount": "公开友链",
      "links.resourcesCount": "参考资源",
      "links.friend": "朋友站点",
      "links.friendLead": "这里只有已经确认并愿意公开的真实交换，不用示例网站填满版面。",
      "links.resource": "网页资源",
      "links.resourceLead": "围绕原生网页开发与 GitHub Pages 发布整理，不替代每个站点自己的说明。",
      ...
      "blog.eyebrow": "写作档案",
      "blog.title": "文章与实践记录",
      "blog.lead": "把已经做过、想明白或值得复习的内容写下来；数量可以慢慢增加，现有文章不拿占位内容凑数。",
    ...
    en: {
      ...
      "uses.eyebrow": "Workbench",
      "uses.title": "How this site is made",
      "uses.lead": "Only the workflow that can be verified from this repository is public for now. Personal devices and daily software can follow once confirmed.",
      "uses.snapshot.kicker": "VERIFIED WORKFLOW",
      "uses.snapshot.note": "Here, “in use” refers only to the verified site workflow — not guessed personal gear.",
      "uses.updated": "Last reviewed",
      "uses.categories": "Workflow groups",
      "uses.steps": "Verified entries",
      "uses.references": "Reference tools",
      "uses.gearTitle": "Verified workbench",
      "uses.gearLead": "Every item below is supported by the current repository structure, files, or publishing method.",
      "uses.toolboxTitle": "Reference toolbox",
      "uses.toolboxLead": "A compact software index to revisit when needed; inclusion does not mean installed, purchased, or currently used.",
      "uses.filterAll": "All",
      "uses.officialSite": "Official site",
      "uses.viewReference": "View reference",
      "uses.empty": "No tools in this category yet.",
      ...
      "links.eyebrow": "Links",
      "links.title": "Bookmarks & connections",
      "links.lead": "Genuine link exchanges and web resources that remain directly relevant to how this site is made.",
      "links.snapshot.kicker": "CURATED LINKS",
      "links.updated": "Last reviewed",
      "links.friendsCount": "Public friends",
      "links.resourcesCount": "References",
      "links.friend": "Friend sites",
      "links.friendLead": "Only confirmed, public exchanges belong here — no placeholder sites added to fill the page.",
      "links.resource": "Web resources",
      "links.resourceLead": "Focused on plain web development and GitHub Pages publishing; each site's own guidance remains authoritative.",
      ...
      "blog.lead": "A record of things built, understood, or worth revisiting. It can grow slowly; placeholders do not count as published writing.",
      "blog.snapshot.kicker": "WRITING ARCHIVE",
